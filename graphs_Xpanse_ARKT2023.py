...
fig, ax = plt.subplots()
math = [0,1,2,3,5,6,7,15,18,19,19.98, 20]  #Скорость
...
fig, ax = plt.subplots()
math = [0,10,15,20,30,50,60, 70,90, 120, 150, 160]  #Скорость
...
fig, ax = plt.subplots()
math = [0, 10, 15, 20, 25, 30]  #Скорость
...
fig, ax = plt.subplots()
math = [0,10,15,20,30,50,60, 70,90, 120, 150, 160]  #Скорость
math_y = [300062.68384336913, 1009363.138547574, 1421256.5703942606, 1964274.826470356, 2493387.0914899735, 4502959.764057175, 2372778.1099207224, 4063981.0682719094, 498504.442048391, 4802777.378697836, 25182899.01934348, 52609750.98130612]

plt.plot(math, math_y, marker='o', label='Наша модель',linestyle = '-', color='green')
ax.set_title('Изменение подъемной силы', fontsize = 15)
# Добавление подписей осей
plt.xlabel('Время (с)')
...
fig, ax = plt.subplots()
math = [0,1,2,3,5,6,7,15,18,19,19.87, 20]  #Скорость
...
# Кладем сетку 10x10 (зеленая)
add_grid(image, 10, (0,0,0))

# Сохраняем изображение с двумя сетками
